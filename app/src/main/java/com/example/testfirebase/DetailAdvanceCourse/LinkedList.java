...
public class LinkedList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = findViewById(R.id.webView_ac_LinkedList);
        webView.loadUrl("http://192.168.1.122:8089/AdvanceCours/Details/16");

        mappingId();
        setSupportActionBar(toolbarDetailStudy);
        toolbarDetailStudy.setTitle(getResources().getString(R.string.titleAClinkedlist));
