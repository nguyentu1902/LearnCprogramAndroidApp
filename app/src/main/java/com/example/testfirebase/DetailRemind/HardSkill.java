...
public class HardSkill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = findViewById(R.id.webView_rm_hardskill);
        webView.loadUrl("http://192.168.1.122:8089/Tips/Details/3");

        mappingId();
        setSupportActionBar(toolbarDetailRemind);
        toolbarDetailRemind.setTitle(getResources().getString(R.string.titleRMhardskill));
