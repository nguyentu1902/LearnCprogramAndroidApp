...
public class Loop2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bc_activity_loop2);

        webView = findViewById(R.id.webView_bc_loopwhile_dowhile);
        webView.loadUrl("http://192.168.1.122:8089/BasicCours/Details/6");

        mappingId();
        setSupportActionBar(toolbarDetailStudy);
        toolbarDetailStudy.setTitle(getResources().getString(R.string.titleBCLoop2));
